...
X_test = pd.read_csv('../../../../Source/Data/X_test_audio_normal_filterbanks.csv')
y_test = pd.read_csv('../../../../Source/Data/y_test_audio_normal_filterbanks.csv')
...
# Load model
model = torch.load('../train/trained_models/many_hidden_normal_filterbanks.pt')
...
# Export results
evaluation.export(predicted, 'predictions/many_hidden_audio_normal_filterbanks.csv')
