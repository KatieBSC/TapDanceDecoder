...
# Load model
model = torch.load('../train/trained_models/vanilla_zcr.pt')
...
# Export results
#evaluation.export(predicted, 'predictions/vanilla_test_zcr.csv')
#evaluation.export(true, 'predictions/true_vanilla_test_zcr.csv')
